...
const SyncQueueItemSchema = CollectionSchema(
  ...
  properties: {
    r'action': PropertySchema(
      ...
      name: r'action',
      type: IsarType.byte,
      enumMap: _SyncQueueItemactionEnumValueMap,
    ),
    ...
    r'entityType': PropertySchema(
      ...
      name: r'entityType',
      type: IsarType.byte,
      enumMap: _SyncQueueItementityTypeEnumValueMap,
    ),
  ...
  idName: r'id',
  indexes: {
    r'entityType_entityUuid': IndexSchema(
      id: -9033069752587194766,
      name: r'entityType_entityUuid',
      unique: false,
      replace: false,
      properties: [
        IndexPropertySchema(
...
SyncQueueItem _syncQueueItemDeserialize(
  ...
  final object = SyncQueueItem(
    action:
        _SyncQueueItemactionValueEnumMap[reader.readByteOrNull(offsets[0])] ??
        SyncAction.create,
    attemptCount: reader.readLongOrNull(offsets[1]) ?? 0,
    createdAt: reader.readDateTime(offsets[2]),
    entityType:
        _SyncQueueItementityTypeValueEnumMap[reader.readByteOrNull(
          offsets[3],
        )] ??
        SyncEntityType.task,
    entityUuid: reader.readString(offsets[4]),
    id: id,
    lastError: reader.readStringOrNull(offsets[5]),
...
P _syncQueueItemDeserializeProp<P>(
  ...
  switch (propertyId) {
    case 0:
      return (_SyncQueueItemactionValueEnumMap[reader.readByteOrNull(offset)] ??
              SyncAction.create)
          as P;
    case 1:
    ...
    case 3:
      return (_SyncQueueItementityTypeValueEnumMap[reader.readByteOrNull(
                offset,
              )] ??
              SyncEntityType.task)
          as P;
...
const _SyncQueueItemactionEnumValueMap = {
  'create': 0,
  'update': 1,
  'delete': 2,
};
const _SyncQueueItemactionValueEnumMap = {
  0: SyncAction.create,
  1: SyncAction.update,
  2: SyncAction.delete,
};
const _SyncQueueItementityTypeEnumValueMap = {'task': 0, 'event': 1};
const _SyncQueueItementityTypeValueEnumMap = {
  0: SyncEntityType.task,
  1: SyncEntityType.event,
};
...
extension SyncQueueItemQueryWhere
  ...
  entityTypeEqualToAnyEntityUuid(SyncEntityType entityType) {
    return QueryBuilder.apply(this, (query) {
      return query.addWhereClause(
        IndexWhereClause.equalTo(
          indexName: r'entityType_entityUuid',
          value: [entityType],
        ),
      );
    });
  ...
  QueryBuilder<SyncQueueItem, SyncQueueItem, QAfterWhereClause>
  entityTypeNotEqualToAnyEntityUuid(SyncEntityType entityType) {
    return QueryBuilder.apply(this, (query) {
      if (query.whereSort == Sort.asc) {
        return query
            .addWhereClause(
  ...
  QueryBuilder<SyncQueueItem, SyncQueueItem, QAfterWhereClause>
  entityTypeGreaterThanAnyEntityUuid(
  ...
  QueryBuilder<SyncQueueItem, SyncQueueItem, QAfterWhereClause>
  entityTypeLessThanAnyEntityUuid(
    SyncEntityType entityType, {
    bool include = false,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<SyncQueueItem, SyncQueueItem, QAfterWhereClause>
  entityTypeBetweenAnyEntityUuid(
    SyncEntityType lowerEntityType,
    SyncEntityType upperEntityType, {
    bool includeLower = true,
    bool includeUpper = true,
  }) {
    return QueryBuilder.apply(this, (query) {
      return query.addWhereClause(
        IndexWhereClause.between(
          indexName: r'entityType_entityUuid',
          lower: [lowerEntityType],
          includeLower: includeLower,
          upper: [upperEntityType],
          includeUpper: includeUpper,
        ),
      );
    });
  ...
  QueryBuilder<SyncQueueItem, SyncQueueItem, QAfterWhereClause>
  entityTypeEntityUuidEqualTo(SyncEntityType entityType, String entityUuid) {
    return QueryBuilder.apply(this, (query) {
      return query.addWhereClause(
        IndexWhereClause.equalTo(
          indexName: r'entityType_entityUuid',
          value: [entityType, entityUuid],
        ),
      );
    });
  }
  ...
  QueryBuilder<SyncQueueItem, SyncQueueItem, QAfterWhereClause>
  entityTypeEqualToEntityUuidNotEqualTo(
    SyncEntityType entityType,
    String entityUuid,
  ) {
    return QueryBuilder.apply(this, (query) {
...
extension SyncQueueItemQueryFilter
  ...
  actionEqualTo(SyncAction value) {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(
  ...
  QueryBuilder<SyncQueueItem, SyncQueueItem, QAfterFilterCondition>
  actionGreaterThan(SyncAction value, {bool include = false}) {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(
        FilterCondition.greaterThan(
          include: include,
  ...
  QueryBuilder<SyncQueueItem, SyncQueueItem, QAfterFilterCondition>
  actionLessThan(SyncAction value, {bool include = false}) {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(
        FilterCondition.lessThan(
          include: include,
...
extension SyncQueueItemQueryProperty
  ...
  QueryBuilder<SyncQueueItem, SyncAction, QQueryOperations> actionProperty() {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<SyncQueueItem, SyncEntityType, QQueryOperations>
  entityTypeProperty() {
    return QueryBuilder.apply(this, (query) {
...
const TodosSchema = CollectionSchema(
  ...
  properties: {
    ...
    r'subtask': PropertySchema(id: 9, name: r'subtask', type: IsarType.string),
...
void _todosSerialize(
  ...
  writer.writeString(offsets[9], object.subtask);
...
Todos _todosDeserialize(
  ...
  final object = Todos(
    ...
    status:
        ...
        TodoStatus.active,
    subtask: reader.readStringOrNull(offsets[9]),
...
extension TodosQueryFilter on QueryBuilder<Todos, Todos, QFilterCondition> {
  ...
  QueryBuilder<Todos, Todos, QAfterFilterCondition> subtaskIsNull() {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(
        const FilterCondition.isNull(property: r'subtask'),
      );
    });
  }

  QueryBuilder<Todos, Todos, QAfterFilterCondition> subtaskIsNotNull() {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(
        const FilterCondition.isNotNull(property: r'subtask'),
      );
    });
  }

  QueryBuilder<Todos, Todos, QAfterFilterCondition> subtaskEqualTo(
    String? value, {
    bool caseSensitive = true,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Todos, Todos, QAfterFilterCondition> subtaskGreaterThan(
    String? value, {
    bool include = false,
    bool caseSensitive = true,
  }) {
  ...
  QueryBuilder<Todos, Todos, QAfterFilterCondition> subtaskLessThan(
    String? value, {
    bool include = false,
    bool caseSensitive = true,
  }) {
  ...
  QueryBuilder<Todos, Todos, QAfterFilterCondition> subtaskBetween(
    String? lower,
    String? upper, {
    bool includeLower = true,
    bool includeUpper = true,
  ...
  QueryBuilder<Todos, Todos, QAfterFilterCondition> subtaskStartsWith(
    String value, {
    bool caseSensitive = true,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Todos, Todos, QAfterFilterCondition> subtaskEndsWith(
    String value, {
    bool caseSensitive = true,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Todos, Todos, QAfterFilterCondition> subtaskContains(
    String value, {
    bool caseSensitive = true,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Todos, Todos, QAfterFilterCondition> subtaskMatches(
    String pattern, {
    bool caseSensitive = true,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Todos, Todos, QAfterFilterCondition> subtaskIsEmpty() {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(
        FilterCondition.equalTo(property: r'subtask', value: ''),
      );
    });
  }

  QueryBuilder<Todos, Todos, QAfterFilterCondition> subtaskIsNotEmpty() {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(
        FilterCondition.greaterThan(property: r'subtask', value: ''),
      );
    });
  }
...
extension TodosQuerySortBy on QueryBuilder<Todos, Todos, QSortBy> {
  ...
  QueryBuilder<Todos, Todos, QAfterSortBy> sortBySubtask() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'subtask', Sort.asc);
    });
  }

  QueryBuilder<Todos, Todos, QAfterSortBy> sortBySubtaskDesc() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'subtask', Sort.desc);
    });
  }
...
extension TodosQuerySortThenBy on QueryBuilder<Todos, Todos, QSortThenBy> {
  ...
  QueryBuilder<Todos, Todos, QAfterSortBy> thenBySubtask() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'subtask', Sort.asc);
    });
  }

  QueryBuilder<Todos, Todos, QAfterSortBy> thenBySubtaskDesc() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'subtask', Sort.desc);
    });
  }
...
extension TodosQueryWhereDistinct on QueryBuilder<Todos, Todos, QDistinct> {
  ...
  QueryBuilder<Todos, Todos, QDistinct> distinctBySubtask({
    bool caseSensitive = true,
  }) {
    return QueryBuilder.apply(this, (query) {
      return query.addDistinctBy(r'subtask', caseSensitive: caseSensitive);
    });
  }
...
extension TodosQueryProperty on QueryBuilder<Todos, Todos, QQueryProperty> {
  ...
  QueryBuilder<Todos, String?, QQueryOperations> subtaskProperty() {
    return QueryBuilder.apply(this, (query) {
      return query.addPropertyName(r'subtask');
    });
  }
...
const _ChatMessagetypeValueEnumMap = {
  ...
  15: MessageType.reasoning,
  16: MessageType.toolCall,
};
